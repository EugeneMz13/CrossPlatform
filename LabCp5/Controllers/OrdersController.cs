...
namespace TaskAuthenticationAuthorization.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            {
                return View(await _context.Orders.Include(o => o.Customer).Include(o => o.SuperMarket).ToListAsync());
            }

            string claim = HttpContext.User.FindFirst(u => u.Type == "customer").Value;
            
            var shoppingContext = _context.Orders
                .Where(o => o.CustomerId.ToString() == claim)
